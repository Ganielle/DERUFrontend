                                ...
                                <MDBCol class="py-2">
                                    <MDBBtn color="success" class="fill-btn"
                                        @click="() => {
                                            ...
                                            isView = false
                                            openPCR = true
                                        }"><div v-if="isAdmin">Edit</div><div v-else>Receive</div></MDBBtn>
                                </MDBCol>
                            </MDBRow>
                        </td>
                    </tr>
    ...
    methods: {
        async UpdatePCR(){
            if (!this.isAdmin){
                ...
                if (this.selectedPCR.fname == "" || this.selectedPCR.lname == "" || 
                this.selectedPCR.dispatchTime == "" || this.selectedPCR.enRoute == "" ||
                this.selectedPCR.atTheScene == "" || this.selectedPCR.atTheFacility){
                    this.toast.open({
